#ifndef Ifc_2x3_parser_hpp
#define Ifc_2x3_parser_hpp
...
struct Ifc_constraint_classification_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_constraint_classification_relationship &o) {
		return os << "Ifc_constraint_classification_relationship(" << o.classified_constraint << ", " << o.related_classifications << ")";
	}
}
...
struct Ifc_constraint_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_constraint_relationship &o) {
		return os << "Ifc_constraint_relationship(" << o.name << ", " << o.description << ", " << o.relating_constraint << ", " << o.related_constraints << ")";
	}
}
...
struct Ifc_symbol_style : IfcPresentationStyle {
...
struct Ifc_texture_coordinate_generator : IfcTextureCoordinate {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_texture_coordinate_generator &o) {
		return os << "Ifc_texture_coordinate_generator(" << o.mode << ", " << o.parameter << ")";
	}
}
...
struct Ifc_texture_map : IfcTextureCoordinate {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_texture_map &o) {
		return os << "Ifc_texture_map(" << o.texture_maps << ")";
	}
}
...
struct Ifc_vertex_based_texture_map : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_vertex_based_texture_map &o) {
		return os << "Ifc_vertex_based_texture_map(" << o.texture_vertices << ", " << o.texture_points << ")";
	}
}
...
struct Ifc_dimension_pair : IfcDraughtingCalloutRelationship {
	Ifc_dimension_pair() {
...
struct Ifc_fill_area_style : IfcPresentationStyle {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_fill_area_style &o) {
		return os << "Ifc_fill_area_style(" << o.name << ", " << o.fill_styles << ")";
	}
}
...
struct Ifc_sound_properties : IfcPropertySetDefinition {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_sound_properties &o) {
		return os << "Ifc_sound_properties(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.is_attenuating << ", " << o.sound_scale << ", " << o.sound_values << ")";
	}
}
...
struct Ifc_annotation_fill_area_occurrence : IfcAnnotationOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_fill_area_occurrence &o) {
		return os << "Ifc_annotation_fill_area_occurrence(" << o.item << ", " << o.styles << ", " << o.name << ", " << o.fill_style_target << ", " << o.global_or_local << ")";
	}
}

struct Ifc_annotation_surface : IfcGeometricRepresentationItem {
...
struct Ifc_rel_associates_profile_properties : IfcRelAssociates {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_associates_profile_properties &o) {
		return os << "Ifc_rel_associates_profile_properties(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.related_objects << ", " << o.relating_profile_properties << ", " << o.profile_section_location << ", " << o.profile_orientation << ")";
	}
}
...
struct Ifc_rel_connects_structural_element : IfcRelConnects {
	Ifc_element *relating_element;
...
struct Ifc_rel_covers_spaces : IfcRelConnects {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_covers_spaces &o) {
		return os << "Ifc_rel_covers_spaces(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.related_space << ", " << o.related_coverings << ")";
	}
}
...
struct Ifc_spatial_structure_element_type : IfcElementType {
...
struct Ifc_space_type : IfcSpatialStructureElementType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_space_type &o) {
		return os << "Ifc_space_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ", " << o.predefined_type << ")";
	}
}
...
struct Ifc_structural_linear_action_varying : IfcStructuralLinearAction {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_linear_action_varying &o) {
		return os << "Ifc_structural_linear_action_varying(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destabilizing_load << ", " << o.caused_by << ", " << o.projected_or_true << ", " << o.varying_applied_load_location << ", " << o.subsequent_applied_loads << ")";
	}
}
...
struct Ifc_structural_planar_action_varying : IfcStructuralPlanarAction {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_planar_action_varying &o) {
		return os << "Ifc_structural_planar_action_varying(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destabilizing_load << ", " << o.caused_by << ", " << o.projected_or_true << ", " << o.varying_applied_load_location << ", " << o.subsequent_applied_loads << ")";
	}
}
