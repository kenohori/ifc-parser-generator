...
namespace Ifc_4_schema {
	...
	struct Ifc_indexed_triangle_texture_map : Ifc_indexed_texture_map {
		std::vector<std::vector<I_n_t_e_g_e_r *>> tex_coord_index;
	...
	struct Ifc_triangulated_face_set : Ifc_tessellated_face_set {
		std::vector<std::vector<I_n_t_e_g_e_r *>> coord_index;
		std::vector<std::vector<I_n_t_e_g_e_r *>> normal_index;
	...
	struct Ifc_rational_b_spline_surface_with_knots : Ifc_b_spline_surface_with_knots {
		std::vector<std::vector<R_e_a_l *>> weights_data;
