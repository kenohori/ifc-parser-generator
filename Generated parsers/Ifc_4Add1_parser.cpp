...
if (boost::iequals(object_class, "IfcBSplineCurve")) {
		...
		o->degree = step_parser.parse_integer(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->control_points_list);
		...
		o->closed_curve = step_parser.parse_integer(object_attributes[%d]);
		o->self_intersect = step_parser.parse_integer(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->control_points_list);
		...
		o->closed_curve = step_parser.parse_integer(object_attributes[%d]);
		o->self_intersect = step_parser.parse_integer(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->knot_multiplicities.push_back((Ifc_integer *)i);
...
if (boost::iequals(object_class, "IfcBSplineSurface")) {
		...
		o->u_degree = step_parser.parse_integer(object_attributes[%d]);
		o->v_degree = step_parser.parse_integer(object_attributes[%d]);
				//TODO: parse container of container
		o->surface_form = step_parser.parse_constant(object_attributes[%d]);
		o->u_closed = step_parser.parse_integer(object_attributes[%d]);
		o->v_closed = step_parser.parse_integer(object_attributes[%d]);
		o->self_intersect = step_parser.parse_integer(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBSplineSurfaceWithKnots")) {
		...
		o->v_closed = step_parser.parse_integer(object_attributes[%d]);
		o->self_intersect = step_parser.parse_integer(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->u_multiplicities.push_back((Ifc_integer *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->u_multiplicities);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->v_multiplicities.push_back((Ifc_integer *)i);
...
if (boost::iequals(object_class, "IfcBlobTexture")) {
		...
		o->repeat_s = step_parser.parse_boolean(object_attributes[%d]);
		o->repeat_t = step_parser.parse_boolean(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef  Ifc_identifier;
...
links_to_resolve.push_back((Ifc **)&o->base_surface);
		o->agreement_flag = step_parser.parse_boolean(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcCartesianPointList2D")) {
...
links_to_resolve.push_back((Ifc **)&o->local_origin);
		o->scale = step_parser.parse_double(object_attributes[%d]);
		o->scale_2 = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->axis_3);
		o->scale_2 = step_parser.parse_double(object_attributes[%d]);
		o->scale_3 = step_parser.parse_double(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->boundaries);
		o->implicit_outer = step_parser.parse_boolean(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->curve_colour);
		o->model_or_draughting = step_parser.parse_boolean(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcDirection")) {
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->direction_ratios.push_back((Ifc_real *)i);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->parameter_takes_precedence = step_parser.parse_boolean(object_attributes[%d]);
		o->sizeable = step_parser.parse_boolean(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->bound);
		o->orientation = step_parser.parse_boolean(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->fill_styles);
		o->modelor_draughting = step_parser.parse_boolean(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcGeometricRepresentationContext")) {
		...
		o->precision = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->colours);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->colour_index.push_back((Ifc_positive_integer *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->colour_index);
if (boost::iequals(object_class, "IfcIndexedPolyCurve")) {
		Ifc_indexed_poly_curve *o = new Ifc_indexed_poly_curve();
		o->points = (Ifc_cartesian_point_list *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->points);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->segments.push_back((Ifc_segment_index_select *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->segments);
		o->self_intersect = step_parser.parse_boolean(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->material);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef  Ifc_label;
		o->priority = step_parser.parse_integer(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->parameter);
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->pixel.push_back((Ifc_binary *)i);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->assigned_items);
		//TODO: parse non-pointer type: typedef  Ifc_identifier;
		o->layer_on = step_parser.parse_integer(object_attributes[%d]);
		o->layer_frozen = step_parser.parse_integer(object_attributes[%d]);
		o->layer_blocked = step_parser.parse_integer(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->knots);
		o->knot_spec = step_parser.parse_constant(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->weights_data.push_back((Ifc_real *)i);
...
links_to_resolve.push_back((Ifc **)&o->basis_surface);
		...
		o->usense = step_parser.parse_boolean(object_attributes[%d]);
		o->vsense = step_parser.parse_boolean(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcReference")) {
		...
		//TODO: parse non-pointer type: typedef  Ifc_identifier;
		//TODO: parse non-pointer type: typedef  Ifc_label;
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->list_positions.push_back((Ifc_integer *)i);
...
links_to_resolve.push_back((Ifc **)&o->relating_element);
		o->related_element = (Ifc_element *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->related_element);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->relating_priorities.push_back((Ifc_integer *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->relating_priorities);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->related_priorities.push_back((Ifc_integer *)i);
...
if (boost::iequals(object_class, "IfcResourceTime")) {
		...
		o->is_over_allocated = step_parser.parse_boolean(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->shape_representations);
		//TODO: parse non-pointer type: typedef  Ifc_label;
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->product_definitional = step_parser.parse_integer(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->representation);
		//TODO: parse non-pointer type: typedef  Ifc_identifier;
		o->number_of_risers = step_parser.parse_integer(object_attributes[%d]);
		o->number_of_treads = step_parser.parse_integer(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->applied_load);
		...
		o->destabilizing_load = step_parser.parse_boolean(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->result_for_load_group);
		o->is_linear = step_parser.parse_boolean(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->row_cells);
		o->is_heading = step_parser.parse_boolean(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		//TODO: parse non-pointer type: typedef  Ifc_label;
		//TODO: parse non-pointer type: typedef  Ifc_label;
		o->is_milestone = step_parser.parse_boolean(object_attributes[%d]);
		o->priority = step_parser.parse_integer(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTaskTime")) {
		...
		o->is_critical = step_parser.parse_boolean(object_attributes[%d]);
		o->status_time = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTaskTimeRecurring")) {
		...
		o->remaining_time = step_parser.parse_string(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->recurrence = (Ifc_recurrence_pattern *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->coordinates);
				//TODO: parse container of container
		o->closed = step_parser.parse_boolean(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->trim_2);
		o->sense_agreement = step_parser.parse_boolean(object_attributes[%d]);
