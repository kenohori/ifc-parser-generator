#ifndef Ifc_2x2_schema_hpp
#define Ifc_2x2_schema_hpp

#include <boost/algorithm/string.hpp>

#include "Step_parser.hpp"

namespace Ifc_2x2_schema {
	...
	struct Ifc_externally_defined_suface_style : Ifc_external_reference {
	...
	struct Ifc_fill_area_style : Ifc {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_fill_area_style &o) {
			return os << "Ifc_fill_area_style(" << "vector(" << o.fill_styles.size() << ")" << ", " << o.name << ")";
		}
	};
	...
	struct Ifc_presentation_layer_assignment : Ifc {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_presentation_layer_assignment &o) {
			return os << "Ifc_presentation_layer_assignment(" << o.name << ", " << o.description << ", " << "vector(" << o.assigned_items.size() << ")" << ")";
		}
	};

	struct Ifc_presentation_layer_assignment_with_style : Ifc_presentation_layer_assignment {
		int layer_number;
		int layer_on;
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_presentation_layer_assignment_with_style &o) {
			return os << "Ifc_presentation_layer_assignment_with_style(" << o.name << ", " << o.description << ", " << "vector(" << o.assigned_items.size() << ")" << ", " << o.layer_number << ", " << o.layer_on << ", " << o.layer_on_in_all_views << ", " << o.layer_frozen << ", " << o.layer_frozen_in_all_views << ", " << o.layer_blocked << ", " << o.layer_colour << ", " << o.layer_curve_width << ", " << o.layer_curve_font << ")";
		}
	};
	...
	struct Ifc_quantity_time : Ifc_physical_quantity {
	...
	struct Ifc_styled_representation : Ifc_representation {
	...
	struct Ifc_surface_style : Ifc {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_surface_style &o) {
			return os << "Ifc_surface_style(" << o.side << ", " << o.name << ", " << "vector(" << o.styles.size() << ")" << ")";
		}
	};
	...
	struct Ifc_text_style : Ifc {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_text_style &o) {
			return os << "Ifc_text_style(" << o.name << ", " << o.character_glyph_appearance << ", " << "vector(" << o.text_styles.size() << ")" << ")";
		}
	};
	...
	struct Ifc_texture_coordinate_generator : Ifc_texture_coordinate {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_texture_coordinate_generator &o) {
			return os << "Ifc_texture_coordinate_generator(" << o.texture << ", " << o.mode << ", " << "vector(" << o.parameter.size() << ")" << ")";
		}
	};
	...
	struct Ifc_texture_map : Ifc_texture_coordinate {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_texture_map &o) {
			return os << "Ifc_texture_map(" << o.texture << ", " << "vector(" << o.vertex_based_textures.size() << ")" << ")";
		}
	};
	...
	struct Ifc_topology_representation : Ifc_representation {
	...
	struct Ifc_vertex_based_texture_map : Ifc {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_vertex_based_texture_map &o) {
			return os << "Ifc_vertex_based_texture_map(" << "vector(" << o.texture_vertices.size() << ")" << ", " << o.vertex_based_geometry << ")";
		}
	};
	...
	struct Ifc_sound_properties : Ifc_property_set_definition {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_sound_properties &o) {
			return os << "Ifc_sound_properties(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.is_attenuating << ", " << o.sound_scale << ", " << o.point_of_measurement << ", " << "vector(" << o.sound_values.size() << ")" << ")";
		}
	};
	...
	struct Ifc_annotation_fill_area : Ifc_geometric_representation_item {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_fill_area &o) {
			return os << "Ifc_annotation_fill_area(" << "vector(" << o.boundaries.size() << ")" << ")";
		}
	};
	...
	struct Ifc_annotation_fill_area_occurrence : Ifc_annotation_occurrence {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_fill_area_occurrence &o) {
			return os << "Ifc_annotation_fill_area_occurrence(" << o.item << ", " << "vector(" << o.styles.size() << ")" << ", " << o.name << ", " << o.fill_style_target << ")";
		}
	};
	...
	struct Ifc_plate : Ifc_building_element_component {
		Ifc_plate() {
			entity = "Ifc_plate";
		}
	...
	struct Ifc_beam_and_column_type : Ifc_building_element_type {
		virtual ~Ifc_beam_and_column_type() {}
	};

	struct Ifc_beam_type : Ifc_beam_and_column_type {
	...
	struct Ifc_building_element_component_type : Ifc_building_element_type {
	...
	struct Ifc_column_type : Ifc_beam_and_column_type {
	...
	struct Ifc_member_type : Ifc_beam_and_column_type {
	...
	struct Ifc_plate_type : Ifc_building_element_component_type {
