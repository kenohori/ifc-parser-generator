#ifndef Ifc_4_schema_hpp
#define Ifc_4_schema_hpp
...
namespace Ifc_4_schema {
	...
	struct Ifc_material_layer : Ifc_material_definition {
		...
		Ifc_text description;
		Ifc_label category;
		Ifc_normalised_ratio_measure priority;
	...
	struct Ifc_task_time_recurring : Ifc_task_time {
		Ifc_recurrence_pattern *recurrance;
	...
	struct Ifc_indexed_colour_map : Ifc_presentation_item {
		...
		Ifc_surface_style_shading *overrides;
		Ifc_colour_rgb_list *colours;
		std::vector<int> colour_index;
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_indexed_colour_map &o) {
			return os << "Ifc_indexed_colour_map(" << o.mapped_to << ", " << o.overrides << ", " << o.colours << ", " << "vector(" << o.colour_index.size() << ")" << ")";
		}
	};
	...
	struct Ifc_mirrored_profile_def : Ifc_derived_profile_def {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_mirrored_profile_def &o) {
			return os << "Ifc_mirrored_profile_def(" << o.profile_type << ", " << o.profile_name << ", " << o.parent_profile << ", " << o._operator << ", " << o.label << ")";
		}
	};
	...
	struct Ifc_rel_connects_path_elements : Ifc_rel_connects_elements {
		std::vector<unsigned int> relating_priorities;
		std::vector<unsigned int> related_priorities;
	...
	struct Ifc_triangulated_face_set : Ifc_tessellated_face_set {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_triangulated_face_set &o) {
			return os << "Ifc_triangulated_face_set(" << o.coordinates << ", " << o.closed << ", " << "vector(" << o.coord_index.size() << ")" << ", " << "vector(" << o.normal_index.size() << ")" << ")";
		}
	};
	...
	struct Ifc_rational_b_spline_surface_with_knots : Ifc_b_spline_surface_with_knots {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_rational_b_spline_surface_with_knots &o) {
			return os << "Ifc_rational_b_spline_surface_with_knots(" << o.u_degree << ", " << o.v_degree << ", " << o.surface_form << ", " << o.u_closed << ", " << o.v_closed << ", " << o.self_intersect << ", " << "vector(" << o.u_multiplicities.size() << ")" << ", " << "vector(" << o.v_multiplicities.size() << ")" << ", " << "vector(" << o.u_knots.size() << ")" << ", " << "vector(" << o.v_knots.size() << ")" << ", " << o.knot_spec << ", " << "vector(" << o.weights_data.size() << ")" << ")";
		}
	};
	...
	struct Ifc_building_system : Ifc_system {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_building_system &o) {
			return os << "Ifc_building_system(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.predefined_type << ")";
		}
	};
	...
	struct Ifc_stair_flight : Ifc_building_element {
		...
		friend std::ostream &operator<<(std::ostream &os, const Ifc_stair_flight &o) {
			return os << "Ifc_stair_flight(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.tag << ", " << o.number_of_riser << ", " << o.number_of_treads << ", " << o.riser_height << ", " << o.tread_length << ", " << o.predefined_type << ")";
		}
	};
