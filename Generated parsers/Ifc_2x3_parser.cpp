...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcAnnotationSurface")) {
		Ifc_annotation_surface *o = new Ifc_annotation_surface();
		o->item = (Ifc_geometric_representation_item *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->item);
		o->texture_coordinates = (Ifc_texture_coordinate *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->texture_transform);
		o->raster_format = step_parser.parse_string(object_attributes[%d]);
		o->step_parser.parse_boolean(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcConstraintClassificationRelationship")) {
		Ifc_constraint_classification_relationship *o = new Ifc_constraint_classification_relationship();
		o->classified_constraint = (Ifc_constraint *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->classified_constraint);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->related_classifications.push_back((Ifc_classification_notation_select *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->related_classifications);
if (boost::iequals(object_class, "IfcConstraintRelationship")) {
...
links_to_resolve.push_back((Ifc **)&o->annotated_curve);
		o->role = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcDimensionPair")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->has_quantities);
		o->discrimination = step_parser.parse_string(object_attributes[%d]);
		o->quality = step_parser.parse_string(object_attributes[%d]);
		o->usage = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->assigned_items);
		...
		//o->step_parser.parse_logical(object_attributes[%d]);
		//o->step_parser.parse_logical(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->layer_styles.push_back((Ifc_presentation_style_select *)i);
...
links_to_resolve.push_back((Ifc **)&o->profile_section_location);
		o->profile_orientation = (Ifc_orientation_select *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcRelConnectsStructuralElement")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->relating_element = (Ifc_element *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->relating_element);
		o->related_structural_member = (Ifc_structural_member *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->related_space = (Ifc_space *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->profile_definition);
		...
		o->centre_of_gravity_in_x = step_parser.parse_double(object_attributes[%d]);
		o->centre_of_gravity_in_y = step_parser.parse_double(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTextStyle")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->text_character_appearance = (Ifc_character_style_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->text_character_appearance);
		o->text_style = (Ifc_text_style_select *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTextStyleWithBoxCharacteristics")) {
		...
		o->character_spacing = (Ifc_size_select *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTextureMap")) {
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->texture_maps.push_back((Ifc_vertex_based_texture_map *)i);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->texture_vertices);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->texture_points.push_back((Ifc_cartesian_point *)i);
