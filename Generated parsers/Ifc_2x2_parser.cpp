...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->request_i_d = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcActorRole")) {
		...
		o->user_defined_role = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcAddress")) {
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->user_defined_purpose = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcAngularDimension")) {
		Ifc_angular_dimension *o = new Ifc_angular_dimension();
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->contents.push_back((Ifc_draughting_callout_element *)i);
...
if (boost::iequals(object_class, "IfcAnnotationCurveOccurrence")) {
...
links_to_resolve.push_back((Ifc **)&o->item);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->styles.push_back((Ifc_presentation_style_assignment *)i);
...
if (boost::iequals(object_class, "IfcAnnotationFillArea")) {
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->boundaries.push_back((Ifc_curve *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->boundaries);
if (boost::iequals(object_class, "IfcAnnotationFillAreaOccurrence")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->fill_style_target = (Ifc_point *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->fill_style_target);
if (boost::iequals(object_class, "IfcAnnotationOccurrence")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcAnnotationSurfaceOccurrence")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcAnnotationSymbolOccurrence")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcAnnotationTextOccurrence")) {
...
links_to_resolve.push_back((Ifc **)&o->unit_basis);
		o->applicable_date = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->applicable_date);
		o->fixed_until_date = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->fixed_until_date);
if (boost::iequals(object_class, "IfcAppliedValueRelationship")) {
		Ifc_applied_value_relationship *o = new Ifc_applied_value_relationship();
		o->component_of_total = (Ifc_applied_value *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcApproval")) {
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->approval_date_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->approval_date_time);
		o->approval_status = step_parser.parse_string(object_attributes[%d]);
		o->approval_level = step_parser.parse_string(object_attributes[%d]);
		o->approval_qualifier = step_parser.parse_string(object_attributes[%d]);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->identifier = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcApprovalActorRelationship")) {
		Ifc_approval_actor_relationship *o = new Ifc_approval_actor_relationship();
		o->actor = (Ifc_actor_select *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->approval);
		o->role = (Ifc_actor_role *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->role);
if (boost::iequals(object_class, "IfcApprovalPropertyRelationship")) {
		Ifc_approval_property_relationship *o = new Ifc_approval_property_relationship();
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->approved_properties.push_back((Ifc_property *)i);
...
if (boost::iequals(object_class, "IfcApprovalRelationship")) {
		...
		o->related_approval = (Ifc_approval *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->asset_i_d = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->tag = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBeamAndColumnType")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBezierCurve")) {
...
if (boost::iequals(object_class, "IfcBoundaryEdgeCondition")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->linear_stiffness_by_length_x = step_parser.parse_double(object_attributes[%d]);
		o->linear_stiffness_by_length_y = step_parser.parse_double(object_attributes[%d]);
		o->linear_stiffness_by_length_z = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_by_length_x = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_by_length_y = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_by_length_z = step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBoundaryFaceCondition")) {
		Ifc_boundary_face_condition *o = new Ifc_boundary_face_condition();
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->linear_stiffness_by_area_x = step_parser.parse_double(object_attributes[%d]);
		o->linear_stiffness_by_area_y = step_parser.parse_double(object_attributes[%d]);
		o->linear_stiffness_by_area_z = step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBoundaryNodeCondition")) {
		Ifc_boundary_node_condition *o = new Ifc_boundary_node_condition();
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->linear_stiffness_x = step_parser.parse_double(object_attributes[%d]);
		o->linear_stiffness_y = step_parser.parse_double(object_attributes[%d]);
		o->linear_stiffness_z = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_x = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_y = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_z = step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBoundaryNodeConditionWarping")) {
		...
		o->rotational_stiffness_y = step_parser.parse_double(object_attributes[%d]);
		o->rotational_stiffness_z = step_parser.parse_double(object_attributes[%d]);
		o->warping_stiffness = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->tag = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBuildingElementComponent")) {
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->tag = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcBuildingElementComponentType")) {
...
links_to_resolve.push_back((Ifc **)&o->axis_3);
		o->step_parser.parse_double(object_attributes[%d]);
		o->step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcChamferEdgeFeature")) {
...
if (boost::iequals(object_class, "IfcClassification")) {
		...
		o->source = step_parser.parse_string(object_attributes[%d]);
		o->edition = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcClassificationNotationFacet")) {
		...
		o->notation_value = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcClassificationReference")) {
		...
		o->item_reference = step_parser.parse_string(object_attributes[%d]);
		o->name = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcCondition")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcConditionCriterion")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->criterion = (Ifc_condition_criterion_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->criterion);
		o->criterion_date_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->creation_time);
		o->user_defined_grade = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->resource_identifier = step_parser.parse_string(object_attributes[%d]);
		o->resource_group = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->suppliers);
		o->usage_ratio = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->submitted_by);
		o->prepared_by = (Ifc_actor_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->prepared_by);
		o->submitted_on = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->target_users);
		o->update_date = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->update_date);
		o->i_d = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->fixed_until_date);
		...
		o->condition = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcCraneRailAShapeProfileDef")) {
...
links_to_resolve.push_back((Ifc **)&o->position);
		...
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
if (boost::iequals(object_class, "IfcCraneRailFShapeProfileDef")) {
...
links_to_resolve.push_back((Ifc **)&o->related_monetary_unit);
		...
		o->rate_date_time = (Ifc_date_and_time *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcDefinedSymbol")) {
		Ifc_defined_symbol *o = new Ifc_defined_symbol();
		o->definition = (Ifc_defined_symbol_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->definition);
		o->target = (Ifc_cartesian_transformation_operator_2_d *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->unit);
		o->step_parser.parse_integer(object_attributes[%d]);
if (boost::iequals(object_class, "IfcDiameterDimension")) {
		Ifc_diameter_dimension *o = new Ifc_diameter_dimension();
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->contents.push_back((Ifc_draughting_callout_element *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->contents);
if (boost::iequals(object_class, "IfcDimensionCalloutRelationship")) {
		Ifc_dimension_callout_relationship *o = new Ifc_dimension_callout_relationship();
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->relating_draughting_callout = (Ifc_draughting_callout *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->relating_draughting_callout);
		o->related_draughting_callout = (Ifc_draughting_callout *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->related_draughting_callout);
if (boost::iequals(object_class, "IfcDimensionCurve")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcDimensionCurveDirectedCallout")) {
		Ifc_dimension_curve_directed_callout *o = new Ifc_dimension_curve_directed_callout();
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->contents.push_back((Ifc_draughting_callout_element *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->contents);
if (boost::iequals(object_class, "IfcDimensionCurveTerminator")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->styles);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->annotated_curve = (Ifc_annotation_curve_occurrence *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcDocumentElectronicFormat")) {
		...
		o->file_extension = step_parser.parse_string(object_attributes[%d]);
		o->mime_content_type = step_parser.parse_string(object_attributes[%d]);
		o->mime_subtype = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcDocumentInformation")) {
		Ifc_document_information *o = new Ifc_document_information();
		o->document_id = step_parser.parse_string(object_attributes[%d]);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->document_references);
		...
		o->revision = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->related_documents);
		o->relationship_type = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->step_parser.parse_boolean(object_attributes[%d]);
if (boost::iequals(object_class, "IfcDraughtingCallout")) {
		Ifc_draughting_callout *o = new Ifc_draughting_callout();
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->contents.push_back((Ifc_draughting_callout_element *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->contents);
if (boost::iequals(object_class, "IfcDraughtingCalloutRelationship")) {
...
if (boost::iequals(object_class, "IfcDraughtingPreDefinedCurveFont")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcDraughtingPreDefinedTextFont")) {
...
links_to_resolve.push_back((Ifc **)&o->edge_geometry);
		o->step_parser.parse_boolean(object_attributes[%d]);
if (boost::iequals(object_class, "IfcEdgeFeature")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcElectricDistributionPoint")) {
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->tag = step_parser.parse_string(object_attributes[%d]);
		o->distribution_point_function = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_function = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcElectricHeaterType")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->energy_sequence = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_energy_sequence = step_parser.parse_string(object_attributes[%d]);
		...
		o->step_parser.parse_integer(object_attributes[%d]);
if (boost::iequals(object_class, "IfcElectricalCircuit")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		o->tag = step_parser.parse_string(object_attributes[%d]);
		o->element_type = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcEnergyProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->energy_sequence = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_energy_sequence = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcEnvironmentalImpactValue")) {
...
links_to_resolve.push_back((Ifc **)&o->applicable_date);
		o->fixed_until_date = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->fixed_until_date);
		o->impact_type = step_parser.parse_string(object_attributes[%d]);
		o->category = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_category = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcExternallyDefinedHatchStyle")) {
		...
		o->item_reference = step_parser.parse_string(object_attributes[%d]);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcExternallyDefinedSufaceStyle")) {
		Ifc_externally_defined_suface_style *o = new Ifc_externally_defined_suface_style();
		o->location = step_parser.parse_string(object_attributes[%d]);
		o->item_reference = step_parser.parse_string(object_attributes[%d]);
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcExternallyDefinedSymbol")) {
...
links_to_resolve.push_back((Ifc **)&o->hatch_line_appearance);
		o->start_of_next_hatch_line = (Ifc_one_direction_repeat_factor *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcFillAreaStyleTileSymbolWithStyle")) {
		Ifc_fill_area_style_tile_symbol_with_style *o = new Ifc_fill_area_style_tile_symbol_with_style();
		o->symbol = (Ifc_annotation_symbol_occurrence *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcFillAreaStyleTiles")) {
		...
		o->tiling_pattern = (Ifc_one_direction_repeat_factor *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->tiling_pattern);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->tiles.push_back((Ifc_fill_area_style_tile_shape_select *)i);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->property_source = step_parser.parse_constant(object_attributes[%d]);
		o->flow_condition_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->flow_condition_time_series);
		o->velocity_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->velocity_time_series);
		o->flowrate_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->fluid);
		o->pressure_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->pressure_time_series);
		o->user_defined_property_source = step_parser.parse_string(object_attributes[%d]);
		o->temperature_single_value = step_parser.parse_double(object_attributes[%d]);
		o->wet_bulb_temperature_single_value = step_parser.parse_double(object_attributes[%d]);
		o->wet_bulb_temperature_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->wet_bulb_temperature_time_series);
		o->temperature_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->temperature_time_series);
		o->flowrate_single_value = (Ifc_derived_measure_value *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->flowrate_single_value);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->velocity_single_value = step_parser.parse_double(object_attributes[%d]);
		o->pressure_single_value = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->tag = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcFuelProperties")) {
		Ifc_fuel_properties *o = new Ifc_fuel_properties();
		o->material = (Ifc_material *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->material);
		o->combustion_temperature = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->lower_heating_value = step_parser.parse_double(object_attributes[%d]);
		o->higher_heating_value = step_parser.parse_double(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->assembly_place = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcGasTerminalType")) {
...
if (boost::iequals(object_class, "IfcGeneralProfileProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->profile_definition);
		o->physical_weight = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
...
links_to_resolve.push_back((Ifc **)&o->parent_context);
		...
		o->user_defined_target_view = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcGridAxis")) {
		...
		o->axis_tag = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcImageTexture")) {
		...
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->texture_type = step_parser.parse_constant(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->texture_transform);
		o->url_reference = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->inventory_type = step_parser.parse_constant(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcIrregularTimeSeries")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->start_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->start_time);
		o->end_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->end_time);
		...
		o->user_defined_data_origin = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcIrregularTimeSeriesValue")) {
		...
		o->time_stamp = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->base_quantity = (Ifc_measure_with_unit *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->base_quantity);
		o->skill_set = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcLinearDimension")) {
...
links_to_resolve.push_back((Ifc **)&o->material);
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->is_ventilated = step_parser.parse_boolean(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->material_layers);
		o->layer_set_name = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcMechanicalConcreteMaterialProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->material);
		...
		o->young_modulus = step_parser.parse_double(object_attributes[%d]);
		o->shear_modulus = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->thermal_expansion_coefficient = step_parser.parse_double(object_attributes[%d]);
		o->compressive_strength = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->admixtures_description = step_parser.parse_string(object_attributes[%d]);
		o->workability = step_parser.parse_string(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_normalised_ratio_measure;
		o->water_impermeability = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->material);
		...
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->thermal_expansion_coefficient = step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcMechanicalSteelMaterialProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->material);
		...
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->thermal_expansion_coefficient = step_parser.parse_double(object_attributes[%d]);
		o->yield_stress = step_parser.parse_double(object_attributes[%d]);
		o->ultimate_stress = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		o->hardening_module = step_parser.parse_double(object_attributes[%d]);
		o->proportional_stress = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->relaxations.push_back((Ifc_relaxation *)i);
...
links_to_resolve.push_back((Ifc **)&o->move_to);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->punch_list.push_back((Ifc_text *)i);
...
links_to_resolve.push_back((Ifc **)&o->creation_time);
		o->user_defined_grade = step_parser.parse_string(object_attributes[%d]);
		o->benchmark_values = (Ifc_metric *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->benchmark_values);
		o->result_values = (Ifc_metric *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->result_values);
		o->objective_qualifier = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_qualifier = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->basis_curve);
		...
		o->ref_direction = (Ifc_direction *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->ref_direction);
if (boost::iequals(object_class, "IfcOneDirectionRepeatFactor")) {
		Ifc_one_direction_repeat_factor *o = new Ifc_one_direction_repeat_factor();
		o->repeat_factor = (Ifc_vector *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->material);
		...
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
if (boost::iequals(object_class, "IfcOrderAction")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->step_parser.parse_integer(object_attributes[%d]);
		o->action_i_d = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcOrganization")) {
		Ifc_organization *o = new Ifc_organization();
		o->_id = step_parser.parse_string(object_attributes[%d]);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->life_cycle_phase = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->permit_i_d = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcPerson")) {
		Ifc_person *o = new Ifc_person();
		o->_id = step_parser.parse_string(object_attributes[%d]);
		o->family_name = step_parser.parse_string(object_attributes[%d]);
		o->given_name = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->texture_transform);
		...
		o->pixel = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcPostalAddress")) {
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->user_defined_purpose = step_parser.parse_string(object_attributes[%d]);
		o->internal_location = step_parser.parse_string(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->address_lines);
		o->postal_box = step_parser.parse_string(object_attributes[%d]);
		o->town = step_parser.parse_string(object_attributes[%d]);
		o->region = step_parser.parse_string(object_attributes[%d]);
		o->postal_code = step_parser.parse_string(object_attributes[%d]);
		o->country = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcPreDefinedCurveFont")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcPreDefinedDimensionSymbol")) {
...
if (boost::iequals(object_class, "IfcPreDefinedItem")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcPreDefinedPointMarkerSymbol")) {
		Ifc_pre_defined_point_marker_symbol *o = new Ifc_pre_defined_point_marker_symbol();
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcPreDefinedSymbol")) {
		Ifc_pre_defined_symbol *o = new Ifc_pre_defined_symbol();
		o->name = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcPreDefinedTerminatorSymbol")) {
...
if (boost::iequals(object_class, "IfcPresentationLayerAssignmentWithStyle")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->assigned_items);
		...
		//o->step_parser.parse_logical(object_attributes[%d]);
		//o->step_parser.parse_logical(object_attributes[%d]);
		o->layer_colour = (Ifc_colour *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->layer_colour);
		o->layer_curve_width = (Ifc_size_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->layer_curve_width);
		o->layer_curve_font = (Ifc_curve_font_or_scaled_curve_font_select *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->procedure_i_d = step_parser.parse_string(object_attributes[%d]);
		o->procedure_type = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_procedure_type = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcProductRepresentation")) {
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->representations.push_back((Ifc_representation *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representations);
if (boost::iequals(object_class, "IfcProductsOfCombustionProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
		o->status = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcProjectOrderRecord")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->records.push_back((Ifc_rel_assigns_to_project_order *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->records);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcProjectionCurve")) {
...
links_to_resolve.push_back((Ifc **)&o->lower_bound_value);
		o->unit = (Ifc_unit *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->unit);
if (boost::iequals(object_class, "IfcPropertyConstraintRelationship")) {
		Ifc_property_constraint_relationship *o = new Ifc_property_constraint_relationship();
		o->relating_constraint = (Ifc_constraint *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->relating_constraint);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->related_properties.push_back((Ifc_property *)i);
...
if (boost::iequals(object_class, "IfcRadiusDimension")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcRationalBezierCurve")) {
...
links_to_resolve.push_back((Ifc **)&o->basis_surface);
		...
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->step_parser.parse_boolean(object_attributes[%d]);
if (boost::iequals(object_class, "IfcReferencesValueDocument")) {
...
links_to_resolve.push_back((Ifc **)&o->referenced_document);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->referencing_values.push_back((Ifc_applied_value *)i);
...
if (boost::iequals(object_class, "IfcReinforcementBarProperties")) {
		...
		o->steel_grade = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->definition_type = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->representation);
		...
		o->cross_section_area = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->bar_role = step_parser.parse_constant(object_attributes[%d]);
		o->bar_surface = step_parser.parse_constant(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcRelAssignsToProjectOrder")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->related_objects);
if (boost::iequals(object_class, "IfcRelAssociatesAppliedValue")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->related_objects.push_back((Ifc_root *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->related_objects);
		o->relating_applied_value = (Ifc_applied_value *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->related_objects.push_back((Ifc_root *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->related_objects);
		o->intent = step_parser.parse_string(object_attributes[%d]);
		o->relating_constraint = (Ifc_constraint *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->relating_constraint);
...
if (boost::iequals(object_class, "IfcRelAssociatesProfileProperties")) {
		Ifc_rel_associates_profile_properties *o = new Ifc_rel_associates_profile_properties();
		o->relating_profile_properties = (Ifc_profile_properties *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->relating_profile_properties);
		o->profile_section_location = (Ifc_shape_aspect *)step_parser.parse_link(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->realizing_elements);
		o->connection_type = step_parser.parse_string(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcRelSchedulesCostItems")) {
...
links_to_resolve.push_back((Ifc **)&o->relating_system);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->related_buildings.push_back((Ifc_spatial_structure_element *)i);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcRelaxation")) {
...
if (boost::iequals(object_class, "IfcRibPlateProfileProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->profile_definition);
		...
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->direction = step_parser.parse_constant(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcRoundedEdgeFeature")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->actual_start = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->actual_start);
		o->early_start = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->early_start);
		o->late_start = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->late_start);
		o->schedule_start = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->schedule_start);
		o->actual_finish = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->actual_finish);
		o->early_finish = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->early_finish);
		o->late_finish = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->late_finish);
		o->schedule_finish = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->schedule_finish);
		...
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->status_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcServiceLife")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		o->service_life_type = step_parser.parse_constant(object_attributes[%d]);
		o->service_life_duration = step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcServiceLifeFactor")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
		o->upper_value = (Ifc_measure_value *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->upper_value);
		o->most_used_value = (Ifc_measure_value *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->most_used_value);
		o->lower_value = (Ifc_measure_value *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcSoundProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->is_attenuating = step_parser.parse_boolean(object_attributes[%d]);
		o->sound_scale = step_parser.parse_constant(object_attributes[%d]);
		o->point_of_measurement = (Ifc_local_placement *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->point_of_measurement);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->sound_values.push_back((Ifc_sound_value *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->sound_values);
if (boost::iequals(object_class, "IfcSoundValue")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->sound_level_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->sound_level_time_series);
		o->frequency = step_parser.parse_double(object_attributes[%d]);
		o->sound_level_single_value = (Ifc_derived_measure_value *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcSpaceThermalLoadProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->maximum_value = step_parser.parse_double(object_attributes[%d]);
		o->minimum_value = step_parser.parse_double(object_attributes[%d]);
		o->thermal_load_time_series_values = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->thermal_load_time_series_values);
		o->user_defined_thermal_load_source = step_parser.parse_string(object_attributes[%d]);
		o->user_defined_property_source = step_parser.parse_string(object_attributes[%d]);
		o->thermal_load_type = step_parser.parse_constant(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->applied_load);
		...
		o->caused_by = (Ifc_structural_reaction *)step_parser.parse_link(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->applied_load);
		...
		o->caused_by = (Ifc_structural_reaction *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->caused_by);
if (boost::iequals(object_class, "IfcStructuralLinearActionVarying")) {
...
links_to_resolve.push_back((Ifc **)&o->applied_load);
		...
		o->caused_by = (Ifc_structural_reaction *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->caused_by);
		o->varying_applied_load_location = (Ifc_shape_aspect *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->varying_applied_load_location);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->subsequent_applied_loads.push_back((Ifc_structural_load *)i);
...
if (boost::iequals(object_class, "IfcStructuralLoadTemperature")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->delta_t___constant = step_parser.parse_double(object_attributes[%d]);
		o->delta_t___y = step_parser.parse_double(object_attributes[%d]);
		o->delta_t___z = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->applied_load);
		...
		o->caused_by = (Ifc_structural_reaction *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->caused_by);
if (boost::iequals(object_class, "IfcStructuralPlanarActionVarying")) {
...
links_to_resolve.push_back((Ifc **)&o->applied_load);
		o->global_or_local = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcStructuralProfileProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->profile_definition);
		...
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->cross_section_area = step_parser.parse_double(object_attributes[%d]);
		o->torsional_constant_x = step_parser.parse_double(object_attributes[%d]);
		o->moment_of_inertia_y_z = step_parser.parse_double(object_attributes[%d]);
		o->moment_of_inertia_y = step_parser.parse_double(object_attributes[%d]);
		o->moment_of_inertia_z = step_parser.parse_double(object_attributes[%d]);
		o->warping_constant = step_parser.parse_double(object_attributes[%d]);
		o->shear_centre_z = step_parser.parse_double(object_attributes[%d]);
		o->shear_centre_y = step_parser.parse_double(object_attributes[%d]);
		o->shear_deformation_area_z = step_parser.parse_double(object_attributes[%d]);
		o->shear_deformation_area_y = step_parser.parse_double(object_attributes[%d]);
		o->maximum_section_modulus_y = step_parser.parse_double(object_attributes[%d]);
		o->minimum_section_modulus_y = step_parser.parse_double(object_attributes[%d]);
		o->maximum_section_modulus_z = step_parser.parse_double(object_attributes[%d]);
		o->minimum_section_modulus_z = step_parser.parse_double(object_attributes[%d]);
		o->torsional_section_modulus = step_parser.parse_double(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->result_for_load_group);
		o->step_parser.parse_boolean(object_attributes[%d]);
if (boost::iequals(object_class, "IfcStructuralSteelProfileProperties")) {
...
links_to_resolve.push_back((Ifc **)&o->profile_definition);
		...
		o->minimum_section_modulus_z = step_parser.parse_double(object_attributes[%d]);
		o->torsional_section_modulus = step_parser.parse_double(object_attributes[%d]);
		o->shear_area_z = step_parser.parse_double(object_attributes[%d]);
		o->shear_area_y = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_positive_ratio_measure;
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->subsequent_thickness.push_back((Ifc_positive_length_measure *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->subsequent_thickness);
		o->varying_thickness_location = (Ifc_shape_aspect *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->varying_thickness_location);
if (boost::iequals(object_class, "IfcStructuredDimensionCallout")) {
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcSymbolStyle")) {
		Ifc_symbol_style *o = new Ifc_symbol_style();
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->style_of_symbol = (Ifc_symbol_style_select *)step_parser.parse_link(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->facsimile_numbers);
		o->pager_number = step_parser.parse_string(object_attributes[%d]);
...
links_to_resolve.push_back((Ifc **)&o->representation);
		o->tag = step_parser.parse_string(object_attributes[%d]);
		o->steel_grade = step_parser.parse_string(object_attributes[%d]);
if (boost::iequals(object_class, "IfcTerminatorSymbol")) {
...
links_to_resolve.push_back((Ifc **)&o->placement);
		...
		o->font = (Ifc_font_select *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTextStyle")) {
		...
		o->name = step_parser.parse_string(object_attributes[%d]);
		o->character_glyph_appearance = (Ifc_character_style_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->character_glyph_appearance);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->text_styles.push_back((Ifc_text_style_select *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->text_styles);
if (boost::iequals(object_class, "IfcTextStyleWithBoxCharacteristics")) {
		Ifc_text_style_with_box_characteristics *o = new Ifc_text_style_with_box_characteristics();
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		//TODO: parse non-pointer type: typedef Ifc_length_measure Ifc_positive_length_measure;
		o->box_slant_angle = step_parser.parse_double(object_attributes[%d]);
		o->box_rotate_angle = step_parser.parse_double(object_attributes[%d]);
if (boost::iequals(object_class, "IfcTextStyleWithMirror")) {
		Ifc_text_style_with_mirror *o = new Ifc_text_style_with_mirror();
		o->mirror_placement = (Ifc_axis_2_placement *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->mirror_placement);
if (boost::iequals(object_class, "IfcTextStyleWithSpacing")) {
		Ifc_text_style_with_spacing *o = new Ifc_text_style_with_spacing();
		o->character_spacing = (Ifc_character_spacing_select *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTextureCoordinate")) {
		...
		o->texture = (Ifc_surface_style_with_textures *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcTextureCoordinateGenerator")) {
		...
		o->texture = (Ifc_surface_style_with_textures *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->texture);
		o->mode = step_parser.parse_string(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->parameter.push_back((Ifc_simple_value *)i);
...
if (boost::iequals(object_class, "IfcTextureMap")) {
		...
		o->texture = (Ifc_surface_style_with_textures *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->texture);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->vertex_based_textures.push_back((Ifc_vertex_based_texture_map *)i);
...
links_to_resolve.push_back((Ifc **)&o->end_time);
		...
		o->unit = (Ifc_unit *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->unit);
if (boost::iequals(object_class, "IfcTimeSeriesReferenceRelationship")) {
		Ifc_time_series_reference_relationship *o = new Ifc_time_series_reference_relationship();
		o->referenced_time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->referenced_time_series);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->time_series_references.push_back((Ifc_document_select *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->time_series_references);
if (boost::iequals(object_class, "IfcTimeSeriesSchedule")) {
...
links_to_resolve.push_back((Ifc **)&o->owner_history);
		...
		o->description = step_parser.parse_string(object_attributes[%d]);
		o->object_type = step_parser.parse_string(object_attributes[%d]);
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->applicable_dates.push_back((Ifc_date_time_select *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->applicable_dates);
		o->time_series_schedule_type = step_parser.parse_constant(object_attributes[%d]);
		o->time_series = (Ifc_time_series *)step_parser.parse_link(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcTwoDirectionRepeatFactor")) {
		Ifc_two_direction_repeat_factor *o = new Ifc_two_direction_repeat_factor();
		o->repeat_factor = (Ifc_vector *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->repeat_factor);
		o->second_repeat_factor = (Ifc_vector *)step_parser.parse_link(object_attributes[%d]);
...
if (boost::iequals(object_class, "IfcVertexBasedTextureMap")) {
		Ifc_vertex_based_texture_map *o = new Ifc_vertex_based_texture_map();
		for (auto i : step_parser.parse_list_of_links(object_attributes[%d])) o->texture_vertices.push_back((Ifc_texture_vertex *)i);
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->texture_vertices);
		o->vertex_based_geometry = (Ifc_poly_loop *)step_parser.parse_link(object_attributes[%d]);
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->representation_maps);
		...
		o->element_type = step_parser.parse_string(object_attributes[%d]);
		o->predefined_type = step_parser.parse_constant(object_attributes[%d]);
if (boost::iequals(object_class, "IfcWaterProperties")) {
		Ifc_water_properties *o = new Ifc_water_properties();
		o->material = (Ifc_material *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->material);
		o->step_parser.parse_boolean(object_attributes[%d]);
		o->hardness = step_parser.parse_double(object_attributes[%d]);
		o->alkalinity_concentration = step_parser.parse_double(object_attributes[%d]);
		o->acidity_concentration = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_normalised_ratio_measure;
		o->p_h_level = step_parser.parse_double(object_attributes[%d]);
		//TODO: parse non-pointer type: typedef Ifc_ratio_measure Ifc_normalised_ratio_measure;
...
lists_of_links_to_resolve.push_back((std::vector<Ifc *> *)&o->creators);
		...
		o->start_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->start_time);
		o->finish_time = (Ifc_date_time_select *)step_parser.parse_link(object_attributes[%d]);
links_to_resolve.push_back((Ifc **)&o->finish_time);
		o->work_control_type = step_parser.parse_constant(object_attributes[%d]);
		o->user_defined_control_type = step_parser.parse_string(object_attributes[%d]);
