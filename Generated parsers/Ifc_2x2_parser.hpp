#ifndef Ifc_2x2_parser_hpp
#define Ifc_2x2_parser_hpp
...
struct Ifc_applied_value_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_applied_value_relationship &o) {
		return os << "Ifc_applied_value_relationship(" << o.component_of_total << ", " << o.components << ", " << o.arithmetic_operator << ", " << o.name << ", " << o.description << ")";
	}
}
...
struct Ifc_approval_property_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_approval_property_relationship &o) {
		return os << "Ifc_approval_property_relationship(" << o.approved_properties << ", " << o.approval << ")";
	}
}
...
struct Ifc_constraint_aggregation_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_constraint_aggregation_relationship &o) {
		return os << "Ifc_constraint_aggregation_relationship(" << o.name << ", " << o.description << ", " << o.relating_constraint << ", " << o.related_constraints << ", " << o.logical_aggregator << ")";
	}
}
...
struct Ifc_curve_style_font_pattern : Ifc {
	Ifc_positive_length_measure visible_segment_length;
...
struct Ifc_environmental_impact_value : IfcAppliedValue {
...
struct Ifc_externally_defined_suface_style : IfcExternalReference {
	Ifc_externally_defined_suface_style() {
		entity = "Ifc_externally_defined_suface_style";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_externally_defined_suface_style &o) {
		return os << "Ifc_externally_defined_suface_style(" << o.location << ", " << o.item_reference << ", " << o.name << ")";
	}
}

struct Ifc_externally_defined_symbol : IfcExternalReference {
...
struct Ifc_fill_area_style : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_fill_area_style &o) {
		return os << "Ifc_fill_area_style(" << o.fill_styles << ", " << o.name << ")";
	}
}
...
struct Ifc_mechanical_steel_material_properties : IfcMechanicalMaterialProperties {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_mechanical_steel_material_properties &o) {
		return os << "Ifc_mechanical_steel_material_properties(" << o.material << ", " << o.dynamic_viscosity << ", " << o.young_modulus << ", " << o.shear_modulus << ", " << o.poisson_ratio << ", " << o.thermal_expansion_coefficient << ", " << o.yield_stress << ", " << o.ultimate_stress << ", " << o.ultimate_strain << ", " << o.hardening_module << ", " << o.proportional_stress << ", " << o.plastic_strain << ", " << o.relaxations << ")";
	}
}
...
struct Ifc_pre_defined_symbol : IfcPreDefinedItem {
	virtual ~Ifc_pre_defined_symbol() {}
}

struct Ifc_pre_defined_terminator_symbol : IfcPreDefinedSymbol {
...
struct Ifc_presentation_layer_assignment : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_presentation_layer_assignment &o) {
		return os << "Ifc_presentation_layer_assignment(" << o.name << ", " << o.description << ", " << o.assigned_items << ")";
	}
}

struct Ifc_presentation_layer_assignment_with_style : IfcPresentationLayerAssignment {
	int layer_number;
	int layer_on;
	int layer_on_in_all_views;
	int layer_frozen;
	int layer_frozen_in_all_views;
	int layer_blocked;
	Ifc_colour *layer_colour;
	Ifc_size_select *layer_curve_width;
	Ifc_curve_font_or_scaled_curve_font_select *layer_curve_font;

	Ifc_presentation_layer_assignment_with_style() {
		entity = "Ifc_presentation_layer_assignment_with_style";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_presentation_layer_assignment_with_style &o) {
		return os << "Ifc_presentation_layer_assignment_with_style(" << o.name << ", " << o.description << ", " << o.assigned_items << ", " << o.layer_number << ", " << o.layer_on << ", " << o.layer_on_in_all_views << ", " << o.layer_frozen << ", " << o.layer_frozen_in_all_views << ", " << o.layer_blocked << ", " << o.layer_colour << ", " << o.layer_curve_width << ", " << o.layer_curve_font << ")";
	}
}
...
struct Ifc_products_of_combustion_properties : IfcMaterialProperties {
...
struct Ifc_property_constraint_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_property_constraint_relationship &o) {
		return os << "Ifc_property_constraint_relationship(" << o.relating_constraint << ", " << o.related_properties << ", " << o.name << ", " << o.description << ")";
	}
}
...
struct Ifc_quantity_time : IfcPhysicalQuantity {
...
struct Ifc_references_value_document : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_references_value_document &o) {
		return os << "Ifc_references_value_document(" << o.referenced_document << ", " << o.referencing_values << ", " << o.name << ", " << o.description << ")";
	}
}
...
struct Ifc_rel_associates_profile_properties : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_associates_profile_properties &o) {
		return os << "Ifc_rel_associates_profile_properties(" << o.relating_profile_properties << ", " << o.profile_section_location << ")";
	}
}
...
struct Ifc_rib_plate_profile_properties : IfcProfileProperties {
...
struct Ifc_structural_load_static : IfcStructuralLoad {
...
struct Ifc_styled_item : IfcRepresentationItem {
	...
	virtual ~Ifc_styled_item() {}
}

struct Ifc_styled_representation : IfcRepresentation {
...
struct Ifc_surface_style : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_surface_style &o) {
		return os << "Ifc_surface_style(" << o.side << ", " << o.name << ", " << o.styles << ")";
	}
}
...
struct Ifc_text_style : Ifc {
	Ifc_label name;
	Ifc_character_style_select *character_glyph_appearance;
	std::vector<Ifc_text_style_select *> text_styles;

	Ifc_text_style() {
		entity = "Ifc_text_style";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_text_style &o) {
		return os << "Ifc_text_style(" << o.name << ", " << o.character_glyph_appearance << ", " << o.text_styles << ")";
	}
}
...
struct Ifc_text_style_with_box_characteristics : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_text_style_with_box_characteristics &o) {
		return os << "Ifc_text_style_with_box_characteristics(" << o.box_height << ", " << o.box_width << ", " << o.box_slant_angle << ", " << o.box_rotate_angle << ")";
	}
}

struct Ifc_text_style_with_mirror : Ifc {
	Ifc_axis_2_placement *mirror_placement;

	Ifc_text_style_with_mirror() {
		entity = "Ifc_text_style_with_mirror";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_text_style_with_mirror &o) {
		return os << "Ifc_text_style_with_mirror(" << o.mirror_placement << ")";
	}
}

struct Ifc_text_style_with_spacing : Ifc {
	Ifc_character_spacing_select *character_spacing;

	Ifc_text_style_with_spacing() {
		entity = "Ifc_text_style_with_spacing";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_text_style_with_spacing &o) {
		return os << "Ifc_text_style_with_spacing(" << o.character_spacing << ")";
	}
}

struct Ifc_texture_coordinate : Ifc {
	Ifc_surface_style_with_textures *texture;
...
struct Ifc_texture_coordinate_generator : IfcTextureCoordinate {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_texture_coordinate_generator &o) {
		return os << "Ifc_texture_coordinate_generator(" << o.texture << ", " << o.mode << ", " << o.parameter << ")";
	}
}

struct Ifc_texture_map : IfcTextureCoordinate {
	std::vector<Ifc_vertex_based_texture_map *> vertex_based_textures;

	Ifc_texture_map() {
		entity = "Ifc_texture_map";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_texture_map &o) {
		return os << "Ifc_texture_map(" << o.texture << ", " << o.vertex_based_textures << ")";
	}
}
...
struct Ifc_time_series_reference_relationship : Ifc {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_time_series_reference_relationship &o) {
		return os << "Ifc_time_series_reference_relationship(" << o.referenced_time_series << ", " << o.time_series_references << ")";
	}
}
...
struct Ifc_topology_representation : IfcRepresentation {
...
struct Ifc_vertex_based_texture_map : Ifc {
	...
	Ifc_poly_loop *vertex_based_geometry;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_vertex_based_texture_map &o) {
		return os << "Ifc_vertex_based_texture_map(" << o.texture_vertices << ", " << o.vertex_based_geometry << ")";
	}
}
...
struct Ifc_water_properties : IfcMaterialProperties {
	bool is_potable;
...
struct Ifc_annotation_occurrence : IfcStyledItem {
	Ifc_label name;

	virtual ~Ifc_annotation_occurrence() {}
}

struct Ifc_annotation_surface_occurrence : IfcAnnotationOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_surface_occurrence &o) {
		return os << "Ifc_annotation_surface_occurrence(" << o.item << ", " << o.styles << ", " << o.name << ")";
	}
}

struct Ifc_annotation_symbol_occurrence : IfcAnnotationOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_symbol_occurrence &o) {
		return os << "Ifc_annotation_symbol_occurrence(" << o.item << ", " << o.styles << ", " << o.name << ")";
	}
}

struct Ifc_annotation_text_occurrence : IfcAnnotationOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_text_occurrence &o) {
		return os << "Ifc_annotation_text_occurrence(" << o.item << ", " << o.styles << ", " << o.name << ")";
	}
}
...
struct Ifc_colour_rgb : IfcColourSpecification {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_colour_rgb &o) {
		return os << "Ifc_colour_rgb(" << o.red << ", " << o.green << ", " << o.blue << ")";
	}
}
...
struct Ifc_dimension_callout_relationship : IfcDraughtingCalloutRelationship {
...
struct Ifc_draughting_pre_defined_text_font : IfcPreDefinedTextFont {
...
struct Ifc_fuel_properties : IfcMaterialProperties {
...
struct Ifc_general_profile_properties : IfcProfileProperties {
...
struct Ifc_mechanical_concrete_material_properties : IfcMechanicalMaterialProperties {
...
struct Ifc_one_direction_repeat_factor : IfcGeometricRepresentationItem {
...
struct Ifc_pixel_texture : IfcSurfaceTexture {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_pixel_texture &o) {
		return os << "Ifc_pixel_texture(" << o.repeat_s << ", " << o.repeat_t << ", " << o.texture_type << ", " << o.texture_transform << ", " << o.width << ", " << o.height << ", " << o.colour_components << ", " << o.pixel << ")";
	}
}
...
struct Ifc_pre_defined_dimension_symbol : IfcPreDefinedSymbol {
...
struct Ifc_pre_defined_point_marker_symbol : IfcPreDefinedSymbol {
...
struct Ifc_reinforcement_definition_properties : IfcPropertySetDefinition {
...
struct Ifc_service_life_factor : IfcPropertySetDefinition {
...
struct Ifc_sound_properties : IfcPropertySetDefinition {
	Ifc_boolean is_attenuating;
	Ifc_sound_scale_enum sound_scale;
	Ifc_local_placement *point_of_measurement;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_sound_properties &o) {
		return os << "Ifc_sound_properties(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.is_attenuating << ", " << o.sound_scale << ", " << o.point_of_measurement << ", " << o.sound_values << ")";
	}
}

struct Ifc_sound_value : IfcPropertySetDefinition {
...
struct Ifc_space_thermal_load_properties : IfcPropertySetDefinition {
...
struct Ifc_structural_profile_properties : IfcGeneralProfileProperties {
...
struct Ifc_structural_steel_profile_properties : IfcStructuralProfileProperties {
...
struct Ifc_structural_surface_member_varying : IfcStructuralSurfaceMember {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_surface_member_varying &o) {
		return os << "Ifc_structural_surface_member_varying(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.predefined_type << ", " << o.thickness << ", " << o.subsequent_thickness << ", " << o.varying_thickness_location << ")";
	}
}
...
struct Ifc_surface_style_rendering : IfcSurfaceStyleShading {
	Ifc_normalised_ratio_measure transparancy;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_surface_style_rendering &o) {
		return os << "Ifc_surface_style_rendering(" << o.surface_colour << ", " << o.transparancy << ", " << o.diffuse_colour << ", " << o.transmission_colour << ", " << o.diffuse_transmission_colour << ", " << o.reflection_colour << ", " << o.specular_colour << ", " << o.specular_highlight << ", " << o.reflectance_method << ")";
	}
}
...
struct Ifc_terminator_symbol : IfcAnnotationSymbolOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_terminator_symbol &o) {
		return os << "Ifc_terminator_symbol(" << o.item << ", " << o.styles << ", " << o.name << ", " << o.annotated_curve << ")";
	}
}
...
struct Ifc_text_literal : IfcGeometricRepresentationItem {
	...
	Ifc_text_alignment alignment;
	Ifc_text_path path;
	Ifc_font_select *font;

	Ifc_text_literal() {
		entity = "Ifc_text_literal";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_text_literal &o) {
		return os << "Ifc_text_literal(" << o.literal << ", " << o.placement << ", " << o.alignment << ", " << o.path << ", " << o.font << ")";
	}
}
...
struct Ifc_text_literal_with_extent : IfcTextLiteral {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_text_literal_with_extent &o) {
		return os << "Ifc_text_literal_with_extent(" << o.literal << ", " << o.placement << ", " << o.alignment << ", " << o.path << ", " << o.font << ", " << o.extent << ")";
	}
}
...
struct Ifc_two_direction_repeat_factor : IfcOneDirectionRepeatFactor {
...
struct Ifc_annotation_curve_occurrence : IfcAnnotationOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_curve_occurrence &o) {
		return os << "Ifc_annotation_curve_occurrence(" << o.item << ", " << o.styles << ", " << o.name << ")";
	}
}

struct Ifc_annotation_fill_area : IfcGeometricRepresentationItem {
	std::vector<Ifc_curve *> boundaries;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_fill_area &o) {
		return os << "Ifc_annotation_fill_area(" << o.boundaries << ")";
	}
}

struct Ifc_annotation_fill_area_occurrence : IfcAnnotationOccurrence {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_annotation_fill_area_occurrence &o) {
		return os << "Ifc_annotation_fill_area_occurrence(" << o.item << ", " << o.styles << ", " << o.name << ", " << o.fill_style_target << ")";
	}
}
...
struct Ifc_cost_schedule : IfcControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_cost_schedule &o) {
		return os << "Ifc_cost_schedule(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.submitted_by << ", " << o.prepared_by << ", " << o.submitted_on << ", " << o.status << ", " << o.target_users << ", " << o.update_date << ", " << o.i_d << ", " << o.predefined_type << ")";
	}
}

struct Ifc_crane_rail_a_shape_profile_def : IfcParameterizedProfileDef {
	Ifc_positive_length_measure overall_hight;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_crane_rail_a_shape_profile_def &o) {
		return os << "Ifc_crane_rail_a_shape_profile_def(" << o.profile_type << ", " << o.profile_name << ", " << o.position << ", " << o.overall_hight << ", " << o.base_width_2 << ", " << o.radius << ", " << o.head_width << ", " << o.head_depth_2 << ", " << o.head_depth_3 << ", " << o.web_thickness << ", " << o.base_width_4 << ", " << o.base_depth_1 << ", " << o.base_depth_2 << ", " << o.base_depth_3 << ", " << o.centre_of_gravity_in_y << ")";
	}
}

struct Ifc_crane_rail_f_shape_profile_def : IfcParameterizedProfileDef {
	Ifc_positive_length_measure overall_hight;
	Ifc_positive_length_measure head_width;
	Ifc_positive_length_measure radius;
	Ifc_positive_length_measure head_depth_2;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_crane_rail_f_shape_profile_def &o) {
		return os << "Ifc_crane_rail_f_shape_profile_def(" << o.profile_type << ", " << o.profile_name << ", " << o.position << ", " << o.overall_hight << ", " << o.head_width << ", " << o.radius << ", " << o.head_depth_2 << ", " << o.head_depth_3 << ", " << o.web_thickness << ", " << o.base_depth_1 << ", " << o.base_depth_2 << ", " << o.centre_of_gravity_in_y << ")";
	}
}
...
struct Ifc_defined_symbol : IfcGeometricRepresentationItem {
...
struct Ifc_dimension_curve : IfcAnnotationCurveOccurrence {
	Ifc_dimension_curve() {
		entity = "Ifc_dimension_curve";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_dimension_curve &o) {
		return os << "Ifc_dimension_curve(" << o.item << ", " << o.styles << ", " << o.name << ")";
	}
}

struct Ifc_dimension_curve_terminator : IfcTerminatorSymbol {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_dimension_curve_terminator &o) {
		return os << "Ifc_dimension_curve_terminator(" << o.item << ", " << o.styles << ", " << o.name << ", " << o.annotated_curve << ", " << o.role << ")";
	}
}
...
struct Ifc_draughting_callout : IfcGeometricRepresentationItem {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_draughting_callout &o) {
		return os << "Ifc_draughting_callout(" << o.contents << ")";
	}
}
...
struct Ifc_energy_properties : IfcPropertySetDefinition {
...
struct Ifc_fill_area_style_hatching : IfcGeometricRepresentationItem {
	...
	Ifc_one_direction_repeat_factor *start_of_next_hatch_line;
...
struct Ifc_fill_area_style_tile_symbol_with_style : IfcGeometricRepresentationItem {
...
struct Ifc_furnishing_element_type : IfcElementType {
	virtual ~Ifc_furnishing_element_type() {}
}
...
struct Ifc_furniture_type : IfcFurnishingElementType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_furniture_type &o) {
		return os << "Ifc_furniture_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ", " << o.assembly_place << ")";
	}
}
...
struct Ifc_inventory : IfcGroup {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_inventory &o) {
		return os << "Ifc_inventory(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.inventory_type << ", " << o.jurisdiction << ", " << o.responsible_persons << ", " << o.last_update_date << ", " << o.current_value << ", " << o.original_value << ")";
	}
}
...
struct Ifc_mechanical_fastener : IfcFastener {
...
struct Ifc_move : IfcTask {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_move &o) {
		return os << "Ifc_move(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.task_id << ", " << o.status << ", " << o.work_method << ", " << o.is_milestone << ", " << o.priority << ", " << o.move_from << ", " << o.move_to << ", " << o.punch_list << ")";
	}
}
...
struct Ifc_order_action : IfcTask {
...
struct Ifc_project_order_record : IfcControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_project_order_record &o) {
		return os << "Ifc_project_order_record(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.records << ", " << o.predefined_type << ")";
	}
}

struct Ifc_projection_curve : IfcAnnotationCurveOccurrence {
	Ifc_projection_curve() {
		entity = "Ifc_projection_curve";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_projection_curve &o) {
		return os << "Ifc_projection_curve(" << o.item << ", " << o.styles << ", " << o.name << ")";
	}
}
...
struct Ifc_rel_assigns_to_project_order : IfcRelAssignsToControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_assigns_to_project_order &o) {
		return os << "Ifc_rel_assigns_to_project_order(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.related_objects << ", " << o.related_objects_type << ", " << o.relating_control << ")";
	}
}
...
struct Ifc_rel_associates_applied_value : IfcRelAssociates {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_associates_applied_value &o) {
		return os << "Ifc_rel_associates_applied_value(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.related_objects << ", " << o.relating_applied_value << ")";
	}
}
...
struct Ifc_rel_projects_element : IfcRelConnects {
	Ifc_element *relating_element;
...
struct Ifc_rel_schedules_cost_items : IfcRelAssignsToControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_schedules_cost_items &o) {
		return os << "Ifc_rel_schedules_cost_items(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.related_objects << ", " << o.related_objects_type << ", " << o.relating_control << ")";
	}
}
...
struct Ifc_service_life : IfcControl {
...
struct Ifc_structural_linear_action : IfcStructuralAction {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_linear_action &o) {
		return os << "Ifc_structural_linear_action(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destablizing_load << ", " << o.projected_or_true << ", " << o.caused_by << ")";
	}
}

struct Ifc_structural_linear_action_varying : IfcStructuralLinearAction {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_linear_action_varying &o) {
		return os << "Ifc_structural_linear_action_varying(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destablizing_load << ", " << o.projected_or_true << ", " << o.caused_by << ", " << o.varying_applied_load_location << ", " << o.subsequent_applied_loads << ")";
	}
}
...
struct Ifc_structural_load_group : IfcGroup {
	...
	Ifc_positive_ratio_measure coefficient;
	Ifc_label purpose;
...
struct Ifc_structural_planar_action : IfcStructuralAction {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_planar_action &o) {
		return os << "Ifc_structural_planar_action(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destablizing_load << ", " << o.projected_or_true << ", " << o.caused_by << ")";
	}
}

struct Ifc_structural_planar_action_varying : IfcStructuralPlanarAction {
	Ifc_shape_aspect *varying_applied_load_location;
	std::vector<Ifc_structural_load *> subsequent_applied_loads;
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_planar_action_varying &o) {
		return os << "Ifc_structural_planar_action_varying(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destablizing_load << ", " << o.projected_or_true << ", " << o.caused_by << ", " << o.varying_applied_load_location << ", " << o.subsequent_applied_loads << ")";
	}
}
...
struct Ifc_structural_point_action : IfcStructuralAction {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_point_action &o) {
		return os << "Ifc_structural_point_action(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.object_placement << ", " << o.representation << ", " << o.applied_load << ", " << o.global_or_local << ", " << o.destablizing_load << ", " << o.projected_or_true << ", " << o.caused_by << ")";
	}
}
...
struct Ifc_structured_dimension_callout : IfcDraughtingCallout {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structured_dimension_callout &o) {
		return os << "Ifc_structured_dimension_callout(" << o.contents << ")";
	}
}
...
struct Ifc_system_furniture_element_type : IfcFurnishingElementType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_system_furniture_element_type &o) {
		return os << "Ifc_system_furniture_element_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ")";
	}
}

struct Ifc_time_series_schedule : IfcControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_time_series_schedule &o) {
		return os << "Ifc_time_series_schedule(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.applicable_dates << ", " << o.time_series_schedule_type << ", " << o.time_series << ")";
	}
}
...
struct Ifc_work_plan : IfcWorkControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_work_plan &o) {
		return os << "Ifc_work_plan(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.identifier << ", " << o.creation_date << ", " << o.creators << ", " << o.purpose << ", " << o.duration << ", " << o.total_float << ", " << o.start_time << ", " << o.finish_time << ", " << o.work_control_type << ", " << o.user_defined_control_type << ")";
	}
}
...
struct Ifc_work_schedule : IfcWorkControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_work_schedule &o) {
		return os << "Ifc_work_schedule(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.identifier << ", " << o.creation_date << ", " << o.creators << ", " << o.purpose << ", " << o.duration << ", " << o.total_float << ", " << o.start_time << ", " << o.finish_time << ", " << o.work_control_type << ", " << o.user_defined_control_type << ")";
	}
}
...
struct Ifc_asymmetric_i_shape_profile_def : IfcIShapeProfileDef {
...
struct Ifc_building_element_component : IfcBuildingElement {
	virtual ~Ifc_building_element_component() {}
}

struct Ifc_building_element_part : IfcBuildingElementComponent {
...
struct Ifc_condition_criterion : IfcControl {
...
struct Ifc_construction_material_resource : IfcConstructionResource {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_construction_material_resource &o) {
		return os << "Ifc_construction_material_resource(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.resource_identifier << ", " << o.resource_group << ", " << o.resource_consumption << ", " << o.base_quantity << ", " << o.suppliers << ", " << o.usage_ratio << ")";
	}
}
...
struct Ifc_dimension_curve_directed_callout : IfcDraughtingCallout {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_dimension_curve_directed_callout &o) {
		return os << "Ifc_dimension_curve_directed_callout(" << o.contents << ")";
	}
}
...
struct Ifc_distribution_element_type : IfcElementType {
	virtual ~Ifc_distribution_element_type() {}
}
...
struct Ifc_edge_feature : IfcFeatureElementSubtraction {
	Ifc_positive_length_measure feature_length;

	virtual ~Ifc_edge_feature() {}
}

struct Ifc_electrical_base_properties : IfcEnergyProperties {
...
struct Ifc_electrical_circuit : IfcSystem {
...
struct Ifc_fastener_type : IfcElementComponentType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_fastener_type &o) {
		return os << "Ifc_fastener_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ")";
	}
}
...
struct Ifc_gas_terminal_type : IfcFlowTerminalType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_gas_terminal_type &o) {
		return os << "Ifc_gas_terminal_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ", " << o.predefined_type << ")";
	}
}
...
struct Ifc_linear_dimension : IfcDimensionCurveDirectedCallout {
	Ifc_linear_dimension() {
		entity = "Ifc_linear_dimension";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_linear_dimension &o) {
		return os << "Ifc_linear_dimension(" << o.contents << ")";
	}
}

struct Ifc_mechanical_fastener_type : IfcFastenerType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_mechanical_fastener_type &o) {
		return os << "Ifc_mechanical_fastener_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ")";
	}
}
...
struct Ifc_plate : IfcBuildingElementComponent {
	Ifc_plate() {
		entity = "Ifc_plate";
	}
...
struct Ifc_reinforcing_element : IfcBuildingElementComponent {
	Ifc_label steel_grade;
...
struct Ifc_rel_assigns_tasks : IfcRelAssignsToControl {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rel_assigns_tasks &o) {
		return os << "Ifc_rel_assigns_tasks(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.related_objects << ", " << o.related_objects_type << ", " << o.relating_control << ", " << o.time_for_task << ")";
	}
}
...
struct Ifc_rounded_edge_feature : IfcEdgeFeature {
	Ifc_positive_length_measure radius;
...
struct Ifc_space_heater_type : IfcEnergyConversionDeviceType {
...
struct Ifc_structural_analysis_model : IfcSystem {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_structural_analysis_model &o) {
		return os << "Ifc_structural_analysis_model(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.object_type << ", " << o.predefined_type << ", " << o.orientation_of_2_d_plane << ", " << o.loaded_by << ", " << o.has_results << ")";
	}
}
...
struct Ifc_angular_dimension : IfcDimensionCurveDirectedCallout {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_angular_dimension &o) {
		return os << "Ifc_angular_dimension(" << o.contents << ")";
	}
}
...
struct Ifc_beam_and_column_type : IfcBuildingElementType {
	virtual ~Ifc_beam_and_column_type() {}
}

struct Ifc_beam_type : IfcBeamAndColumnType {
...
struct Ifc_bezier_curve : IfcBSplineCurve {
	Ifc_bezier_curve() {
		entity = "Ifc_bezier_curve";
	}
	friend std::ostream &operator<<(std::ostream &os, const Ifc_bezier_curve &o) {
		return os << "Ifc_bezier_curve(" << o.degree << ", " << o.control_points_list << ", " << o.curve_form << ", " << o.closed_curve << ", " << o.self_intersect << ")";
	}
}
...
struct Ifc_building_element_component_type : IfcBuildingElementType {
	virtual ~Ifc_building_element_component_type() {}
}
...
struct Ifc_chamfer_edge_feature : IfcEdgeFeature {
	Ifc_positive_length_measure width;
...
struct Ifc_column_type : IfcBeamAndColumnType {
...
struct Ifc_diameter_dimension : IfcDimensionCurveDirectedCallout {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_diameter_dimension &o) {
		return os << "Ifc_diameter_dimension(" << o.contents << ")";
	}
}
...
struct Ifc_discrete_accessory_type : IfcElementComponentType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_discrete_accessory_type &o) {
		return os << "Ifc_discrete_accessory_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ")";
	}
}
...
struct Ifc_electric_distribution_point : IfcFlowController {
...
struct Ifc_electric_heater_type : IfcFlowTerminalType {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_electric_heater_type &o) {
		return os << "Ifc_electric_heater_type(" << o.global_id << ", " << o.owner_history << ", " << o.name << ", " << o.description << ", " << o.applicable_occurrence << ", " << o.has_property_sets << ", " << o.representation_maps << ", " << o.tag << ", " << o.element_type << ", " << o.predefined_type << ")";
	}
}
...
struct Ifc_member_type : IfcBeamAndColumnType {
...
struct Ifc_plate_type : IfcBuildingElementComponentType {
...
struct Ifc_rational_bezier_curve : IfcBezierCurve {
	...
	friend std::ostream &operator<<(std::ostream &os, const Ifc_rational_bezier_curve &o) {
		return os << "Ifc_rational_bezier_curve(" << o.degree << ", " << o.control_points_list << ", " << o.curve_form << ", " << o.closed_curve << ", " << o.self_intersect << ", " << o.weights_data << ")";
	}
}
...
struct Ifc_vibration_isolator_type : IfcDiscreteAccessoryType {
